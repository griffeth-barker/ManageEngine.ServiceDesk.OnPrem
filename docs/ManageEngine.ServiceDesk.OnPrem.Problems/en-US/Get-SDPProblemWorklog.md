...
### List (Default)
```
Get-SDPProblemWorklog -ProblemId <String> [-PageSize <Int32>] [-StartIndex <Int32>] [-All]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Id
```
Get-SDPProblemWorklog -ProblemId <String> -Id <String> [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
