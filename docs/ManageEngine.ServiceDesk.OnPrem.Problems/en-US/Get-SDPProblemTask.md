...
### List (Default)
```
Get-SDPProblemTask -ProblemId <String> [-PageSize <Int32>] [-StartIndex <Int32>] [-All]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Id
```
Get-SDPProblemTask -ProblemId <String> -Id <String> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
