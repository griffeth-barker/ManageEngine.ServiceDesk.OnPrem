...
### List (Default)
```
Get-SDPProblemTemplate [-PageSize <Int32>] [-StartIndex <Int32>] [-All] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```

### Id
```
Get-SDPProblemTemplate -Id <String> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
