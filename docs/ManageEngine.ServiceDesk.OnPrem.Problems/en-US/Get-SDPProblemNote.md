...
### List (Default)
```
Get-SDPProblemNote -ProblemId <String> [-PageSize <Int32>] [-StartIndex <Int32>] [-All]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Id
```
Get-SDPProblemNote -ProblemId <String> -Id <String> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
