...
### List (Default)
```
Get-SDPProblem [-PageSize <Int32>] [-StartIndex <Int32>] [-SortField <String>] [-SortOrder <String>]
 [-Filter <Hashtable[]>] [-All] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Id
```
Get-SDPProblem -Id <String> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
