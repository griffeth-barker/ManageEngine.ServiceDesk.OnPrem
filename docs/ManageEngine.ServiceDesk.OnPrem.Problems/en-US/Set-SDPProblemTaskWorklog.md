...
```
Set-SDPProblemTaskWorklog [-ProblemId] <String> [-TaskId] <String> [-Id] <String> [[-Description] <String>]
 [[-OwnerName] <String>] [[-StartTime] <DateTime>] [[-EndTime] <DateTime>]
 [[-IncludeNonOperationalHours] <Boolean>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
