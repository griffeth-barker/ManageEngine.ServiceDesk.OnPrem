...
### List (Default)
```
Get-SDPProblemTaskWorklog -ProblemId <String> -TaskId <String> [-PageSize <Int32>] [-StartIndex <Int32>] [-All]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### WorklogId
```
Get-SDPProblemTaskWorklog -ProblemId <String> -TaskId <String> -WorklogId <String>
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
### -WorklogId
{{ Fill WorklogId Description }}

```yaml
Type: String
Parameter Sets: WorklogId
Aliases:
