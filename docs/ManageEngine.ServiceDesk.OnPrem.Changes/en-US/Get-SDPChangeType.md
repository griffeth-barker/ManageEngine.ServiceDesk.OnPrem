...
### List (Default)
```
Get-SDPChangeType [-PageSize <Int32>] [-StartIndex <Int32>] [-All] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```

### Id
```
Get-SDPChangeType -Id <String> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
