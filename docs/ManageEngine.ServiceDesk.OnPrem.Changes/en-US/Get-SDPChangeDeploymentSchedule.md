...
### List (Default)
```
Get-SDPChangeDeploymentSchedule -ChangeId <String> [-PageSize <Int32>] [-StartIndex <Int32>] [-All]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Id
```
Get-SDPChangeDeploymentSchedule -ChangeId <String> -Id <String> [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
