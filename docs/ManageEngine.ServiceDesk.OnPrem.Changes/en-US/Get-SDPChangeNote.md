...
### List (Default)
```
Get-SDPChangeNote -ChangeId <String> [-PageSize <Int32>] [-StartIndex <Int32>] [-All]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Id
```
Get-SDPChangeNote -ChangeId <String> -Id <String> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
