...
### List (Default)
```
Get-SDPChangeReason [-PageSize <Int32>] [-StartIndex <Int32>] [-All] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```

### Id
```
Get-SDPChangeReason -Id <String> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
