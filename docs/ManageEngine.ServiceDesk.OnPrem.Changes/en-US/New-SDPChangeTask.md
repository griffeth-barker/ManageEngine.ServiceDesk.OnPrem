...
```
New-SDPChangeTask [-ChangeId] <String> [-Title] <String> [[-Description] <String>] [[-StatusName] <String>]
 [[-PriorityName] <String>] [[-OwnerName] <String>] [[-GroupName] <String>] [[-ScheduledStartTime] <DateTime>]
 [[-ScheduledEndTime] <DateTime>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
