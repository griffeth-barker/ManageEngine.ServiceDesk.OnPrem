...
### List (Default)
```
Get-SDPChangeTask -ChangeId <String> [-PageSize <Int32>] [-StartIndex <Int32>] [-All]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Id
```
Get-SDPChangeTask -ChangeId <String> -Id <String> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
