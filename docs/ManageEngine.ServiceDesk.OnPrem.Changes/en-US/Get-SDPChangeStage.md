...
### List (Default)
```
Get-SDPChangeStage [-PageSize <Int32>] [-StartIndex <Int32>] [-All] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```

### Id
```
Get-SDPChangeStage -Id <String> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
