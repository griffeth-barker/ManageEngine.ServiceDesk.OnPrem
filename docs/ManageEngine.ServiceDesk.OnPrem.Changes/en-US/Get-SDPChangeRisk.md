...
### List (Default)
```
Get-SDPChangeRisk [-PageSize <Int32>] [-StartIndex <Int32>] [-All] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```

### Id
```
Get-SDPChangeRisk -Id <String> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
