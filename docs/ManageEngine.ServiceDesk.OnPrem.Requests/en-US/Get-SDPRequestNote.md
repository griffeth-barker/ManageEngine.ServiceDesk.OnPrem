...
### List (Default)
```
Get-SDPRequestNote -RequestId <String> [-PageSize <Int32>] [-StartIndex <Int32>] [-All]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Id
```
Get-SDPRequestNote -RequestId <String> -Id <String> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
