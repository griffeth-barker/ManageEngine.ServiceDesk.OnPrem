...
## SYNOPSIS
Retrieves worklogs for a ServiceDesk Plus request.

## SYNTAX

### List (Default)
```
Get-SDPRequestWorklog -RequestId <String> [-PageSize <Int32>] [-StartIndex <Int32>] [-All]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Id
```
Get-SDPRequestWorklog -RequestId <String> -Id <String> [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
### EXAMPLE 2
```
Get-SDPRequestWorklog -RequestId '12345' -Id '1'
```
