...
### List (Default)
```
Get-SDPSupportGroup [-PageSize <Int32>] [-StartIndex <Int32>] [-All] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```

### Id
```
Get-SDPSupportGroup -Id <String> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
