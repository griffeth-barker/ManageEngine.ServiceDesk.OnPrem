...
### List (Default)
```
Get-SDPRegion [-PageSize <Int32>] [-StartIndex <Int32>] [-All] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```

### Id
```
Get-SDPRegion -Id <String> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
