...
### List (Default)
```
Get-SDPDepartment [-PageSize <Int32>] [-StartIndex <Int32>] [-All] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```

### Id
```
Get-SDPDepartment -Id <String> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
