...
### List (Default)
```
Get-SDPStatus [-PageSize <Int32>] [-StartIndex <Int32>] [-All] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```

### Id
```
Get-SDPStatus -Id <String> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
