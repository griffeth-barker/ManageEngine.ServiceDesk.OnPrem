...
### List (Default)
```
Get-SDPUrgency [-PageSize <Int32>] [-StartIndex <Int32>] [-All] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```

### Id
```
Get-SDPUrgency -Id <String> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
