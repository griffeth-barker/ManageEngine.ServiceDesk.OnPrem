...
```
New-SDPUser [-Name] <String> [[-FirstName] <String>] [[-MiddleName] <String>] [[-LastName] <String>]
 [[-LoginName] <String>] [[-EmailId] <String>] [[-Phone] <String>] [[-Mobile] <String>] [[-JobTitle] <String>]
 [[-EmployeeId] <String>] [[-Description] <String>] [-IsVipUser] [[-DepartmentId] <String>]
