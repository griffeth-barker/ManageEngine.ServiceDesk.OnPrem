...
### List (Default)
```
Get-SDPOrgUser [-PageSize <Int32>] [-StartIndex <Int32>] [-SortField <String>] [-SortOrder <String>] [-All]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Id
```
Get-SDPOrgUser -Id <String> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
