...
### List (Default)
```
Get-SDPUser [-PageSize <Int32>] [-StartIndex <Int32>] [-SortField <String>] [-SortOrder <String>] [-All]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Id
```
Get-SDPUser -Id <String> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
