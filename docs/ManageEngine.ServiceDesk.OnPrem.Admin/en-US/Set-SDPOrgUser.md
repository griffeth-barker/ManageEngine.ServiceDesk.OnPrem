...
```
Set-SDPOrgUser [-Id] <String> [[-Name] <String>] [[-FirstName] <String>] [[-MiddleName] <String>]
 [[-LastName] <String>] [[-LoginName] <String>] [[-EmailId] <String>] [[-Phone] <String>] [[-Mobile] <String>]
 [[-JobTitle] <String>] [[-EmployeeId] <String>] [[-IsVipUser] <Boolean>] [[-DepartmentId] <String>]
 [[-ReportingToId] <String>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
