...
### List (Default)
```
Get-SDPAnnouncement [-PageSize <Int32>] [-StartIndex <Int32>] [-All] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```

### Id
```
Get-SDPAnnouncement -Id <String> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
