...
### List (Default)
```
Get-SDPLevel [-PageSize <Int32>] [-StartIndex <Int32>] [-All] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```

### Id
```
Get-SDPLevel -Id <String> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
