...
### List (Default)
```
Get-SDPReminder [-PageSize <Int32>] [-StartIndex <Int32>] [-All] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```

### Id
```
Get-SDPReminder -Id <String> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
