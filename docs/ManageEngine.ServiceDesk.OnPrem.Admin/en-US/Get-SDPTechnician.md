...
### List (Default)
```
Get-SDPTechnician [-PageSize <Int32>] [-StartIndex <Int32>] [-SortField <String>] [-SortOrder <String>] [-All]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Id
```
Get-SDPTechnician -Id <String> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
