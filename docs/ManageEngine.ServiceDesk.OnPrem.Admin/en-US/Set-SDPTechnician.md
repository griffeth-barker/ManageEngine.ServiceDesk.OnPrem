...
```
Set-SDPTechnician [-Id] <String> [[-Name] <String>] [[-EmailId] <String>] [[-Phone] <String>]
 [[-Mobile] <String>] [[-JobTitle] <String>] [[-EmployeeId] <String>] [[-IsVipUser] <Boolean>]
 [[-DepartmentId] <String>] [[-ReportingToId] <String>] [-ProgressAction <ActionPreference>] [-WhatIf]
